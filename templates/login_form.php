 ...
 <div class="grid-col widgeted">
	 <div id="usercontrol" class="user-control">
			...
			<form id="login" class="user-control-form" method="post" action="<?php echo wp_login_url(); ?>">
			  <input type="text" name="log" id="user_login" class="username"  placeholder="<?php _e('&#xf090; Email Adress','user-control');?>"/>
			  <input type="password" name="pwd" id="user_pass"  class="password"  placeholder="<?php _e('&#xf09c; Password','user-control');?>"/>
			  ...
			  <a class="forgot-password" href="<?php echo wp_registration_url(); ?>"><?php _e( 'Register', 'user-control' ); ?></a>
